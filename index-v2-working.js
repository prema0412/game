...
const startGame = () => {
  ...
  expectedResponse = 'N'
      ...
      handlerOne = setInterval(() => {
        ...
        changeColor("#60100B", "rgb(129, 26, 26)","rgb(153, 93, 93)","rgb(226, 24, 24)", "#610C04");
...
handlerEight = setInterval(() => {
  ...
  const changeColor = ( (color1, color2, color3, color4, color5) => {
    ...
    document.getElementById('path1').style.color = color2;
    document.getElementById('path2').style.color = color3;
    document.getElementById('path3').style.color = color4;
    document.getElementById('polygon').style.color = color5;
